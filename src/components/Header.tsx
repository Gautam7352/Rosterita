...
import { Calendar, Sparkles, Download, ShieldCheck, RotateCcw, Users, Palmtree, UserCheck } from 'lucide-react';
  ...
  return (
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        ...
        <div className="flex items-center gap-1 mt-3 pt-2 border-t border-slate-100 text-xs font-medium overflow-x-auto pb-1 hide-scrollbar">
          <button
          ...
          >
            ...
            {approvedLeaveCount > 0 && (
              <span className="px-1.5 py-0.2 text-[10px] font-bold bg-slate-200 text-slate-800 rounded-full">
                {approvedLeaveCount}
              </span>
            )}
          </button>
